...
function validateForm() {
    ...
    var cena = document.forms["tvForma"]["cena"].value;
...
<c:if test="${ not empty zaIzmenu}">
    <form name="tvForma" onsubmit="return validateForm()"   method="POST" action="dodaj-tv">
                 <table border='1'>
                    ...
                    <td>Marka</td>
                      <td><select name="marka">
                    <option value="0" <c:if test="${zaIzmenu.model == 'Samsung'}"> selected </c:if> >Samsung</option>
                    <option value="2" <c:if test="${zaIzmenu.model == 'Lg'}"> selected </c:if> >Lg </option>
                    <option value="1" <c:if test="${zaIzmenu.model == 'Panasonic'}"> selected </c:if> >Panasonic</option>
                    </select>
                </td>
                    </tr>
                    <tr>
